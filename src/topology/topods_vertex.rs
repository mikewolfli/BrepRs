...
impl TopoDS_Vertex {
    ...
    pub fn new(point: Point) -> Self {
        Self {
            shape: TopoDS_Shape::new(crate::topology::shape_enum::ShapeType::Vertex),
            point,
            tolerance: 0.001,
        }
    }
    ...
    pub fn is_equal(&self, other: &TopoDS_Vertex) -> bool {
    ...
    pub fn distance(&self, other: &TopoDS_Vertex) -> f64 {
        let dx = self.point.x - other.point.x;
        let dy = self.point.y - other.point.y;
        let dz = self.point.z - other.point.z;
    ...
    pub fn square_distance(&self, other: &TopoDS_Vertex) -> f64 {
        let dx = self.point.x - other.point.x;
        let dy = self.point.y - other.point.y;
        let dz = self.point.z - other.point.z;
        dx * dx + dy * dy + dz * dz
...
impl Default for TopoDS_Vertex {
    fn default() -> Self {
        Self::new(Point::origin())
    }
}

impl Clone for TopoDS_Vertex {
    fn clone(&self) -> Self {
        Self {
...
impl PartialEq for TopoDS_Vertex {
...
mod tests {
    ...
    fn test_vertex_creation() {
        ...
        let vertex = TopoDS_Vertex::new(point);
    ...
    fn test_vertex_with_tolerance() {
        let point = Point::new(1.0, 2.0, 3.0);
        let vertex = TopoDS_Vertex::with_tolerance(point, 0.01);
    ...
    fn test_vertex_equality() {
        let vertex1 = TopoDS_Vertex::new(Point::new(1.0, 2.0, 3.0));
        let vertex2 = TopoDS_Vertex::new(Point::new(1.0, 2.0, 3.0));
        // 差值为0.002，大于tolerance(0.001)，所以应该不相等
        let vertex3 = TopoDS_Vertex::new(Point::new(1.002, 2.0, 3.0));
    ...
    fn test_vertex_distance() {
        let vertex1 = TopoDS_Vertex::new(Point::new(0.0, 0.0, 0.0));
        let vertex2 = TopoDS_Vertex::new(Point::new(3.0, 4.0, 0.0));
    ...
    fn test_vertex_coordinates() {
        let mut vertex = TopoDS_Vertex::new(Point::new(1.0, 2.0, 3.0));
    ...
    fn test_vertex_is_origin() {
        let origin_vertex = TopoDS_Vertex::new(Point::origin());
        assert!(origin_vertex.is_origin());
        
        let other_vertex = TopoDS_Vertex::new(Point::new(1.0, 0.0, 0.0));
    ...
    fn test_vertex_clone() {
        let mut vertex1 = TopoDS_Vertex::new(Point::new(1.0, 2.0, 3.0));
