...
mod tests {
    ...
    fn test_line_is_parallel() {
        let line1 = Line::new(Point::origin(), Direction::x_axis());
        let line2 = Line::new(Point::new(0.0, 1.0, 0.0), Direction::x_axis());
        assert!(line1.is_parallel(&line2, 0.001));
    }

    #[test]
    fn test_line_is_normal() {
        let line1 = Line::new(Point::origin(), Direction::x_axis());
        let line2 = Line::new(Point::origin(), Direction::y_axis());
    ...
    #[test]
    fn test_line_scale() {
        let mut line = Line::new(Point::new(1.0, 0.0, 0.0), Direction::x_axis());
    ...
    #[test]
    fn test_line_rotate() {
        let mut line = Line::new(Point::origin(), Direction::x_axis());
    ...
    #[test]
    fn test_line_distance_line() {
        let line1 = Line::new(Point::origin(), Direction::x_axis());
        let line2 = Line::new(Point::new(0.0, 1.0, 0.0), Direction::x_axis());
        let distance = line1.distance_line(&line2);
        assert!((distance - 1.0).abs() < 0.001);
    }
}
