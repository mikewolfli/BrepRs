...
/// Torus geometric primitive
///
/// A torus is a surface of revolution generated by revolving a circle in three-dimensional space
/// about an axis that is coplanar with the circle. If the axis of revolution does not touch the circle,
/// the surface has a ring shape and is called a torus of revolution.
