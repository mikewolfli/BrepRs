...
impl Ellipse {
    ...
    pub fn mirrored(&self, point: &Point) -> Ellipse {
        Ellipse {
    ...
    pub fn mirrored_axis(&self, axis: &Axis) -> Ellipse {
        Ellipse {
    ...
    pub fn translated(&self, vec: &Vector) -> Ellipse {
        Ellipse {
    ...
    pub fn transformed(&self, trsf: &crate::geometry::Transform) -> Ellipse {
        Ellipse {
...
mod tests {
    ...
    fn test_ellipse_creation() {
        ...
        let ellipse = Ellipse::new(center, x_direction, major_radius, minor_radius);
    ...
    #[test]
    fn test_ellipse_from_center_radii() {
        let center = Point::origin();
        let major_radius = 5.0;
        let minor_radius = 3.0;
        let ellipse = Ellipse::from_center_radii(center, major_radius, minor_radius);
        assert_eq!(ellipse.location(), &center);
        assert_eq!(ellipse.major_radius(), major_radius);
        assert_eq!(ellipse.minor_radius(), minor_radius);
    }
    ...
    fn test_ellipse_area() {
        let ellipse = Ellipse::from_center_radii(Point::origin(), 5.0, 3.0);
    ...
    fn test_ellipse_is_circle() {
        let ellipse = Ellipse::from_center_radii(Point::origin(), 5.0, 5.0);
        assert!(ellipse.is_circle(0.001));
    }

    #[test]
    fn test_ellipse_translate() {
        let mut ellipse = Ellipse::from_center_radii(Point::origin(), 5.0, 3.0);
    ...
    #[test]
    fn test_ellipse_to_axis() {
        let ellipse = Ellipse::from_center_radii(Point::origin(), 5.0, 3.0);
        let axis = ellipse.to_axis();
