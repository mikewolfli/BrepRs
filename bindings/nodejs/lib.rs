//! Node.js bindings for BrepRs using NAPI-RS
//!
//! This module provides Node.js bindings for BrepRs.
...
#[napi]
pub fn i18n_set_language(lang_code: String) -> Result<bool> {
